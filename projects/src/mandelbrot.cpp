...
private:
    ...
    struct PSPerObjectConstants
    {
        ...
        float        m_PSColorB[3];
        float        m_Padding1[1];
        unsigned int m_PSMaxIteration[1];
        unsigned int m_Padding2[3];
    };
...
bool CApplication::InternOnFrame()
{
    ...
    PerObjectConstantsPS.m_PSColorA[1] = 1.0f;   // G
    PerObjectConstantsPS.m_PSColorA[2] = 1.0f;   // B

    PerObjectConstantsPS.m_PSColorB[0] = 0.0f;   // R
    PerObjectConstantsPS.m_PSColorB[1] = 1.0f;   // G
    PerObjectConstantsPS.m_PSColorB[2] = 0.0f;   // B

    PerObjectConstantsPS.m_PSMaxIteration[0] = 100;
